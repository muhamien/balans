                    ...
                    <div className="w-full bg-white border-[#73B729] border rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 ">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form>
                                ...
                                {
                                    userType === "jobs" ? (
                                        <a href="jobs" className="text-white bg-[#73B729] hover:bg-[#137536] ease-out duration-300 focus:ring-4 focus:outline-none focus:ring-[#137536] font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Simpan</a>
                                    ) : (
                                        <a href="myJobs" className="text-white bg-[#73B729] hover:bg-[#137536] ease-out duration-300 focus:ring-4 focus:outline-none focus:ring-[#137536] font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Simpan</a>
                                    )
                                }
                            </form>
